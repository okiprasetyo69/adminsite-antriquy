  ...
  $.fn.fireModal = function(options) {
    ...
    this.each(function() {
      ...
      options.buttons.forEach(function(item) {
        ...
        // Button template
        this_button = '<button type="'+ ("submit" in item && item.submit == true ? 'submit' : 'button') +'" class="'+ item.class +'" id="'+ id +'" style="display:'+("display" in item && item.display == false ? 'none' : 'block')+';">'+ item.text +'</button>';
